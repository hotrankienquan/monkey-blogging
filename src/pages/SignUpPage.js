...
const SignUpPage = () => {
  ...
  console.log(">>> check auth from firebase conffig", auth)
  const handleSignUp = async (values) => {
    console.log(">>> print values handleSignUp", values)
    if (!isValid) return;
    await createUserWithEmailAndPassword(auth, values.email, values.password); // function of firebase
